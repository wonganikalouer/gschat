...
function scale(obj,effect){
  get(obj).style.transform="scale("+effect+")"
get(obj).style.webkitTransform="scale("+effect+")"
...
function hideExcept(id,pos) {
	var parent=get(id).children
...
function connect(link,loader,error_bool){
var respond=""
var e=error_bool
try{
